...
public class EnemyBase : MonoBehaviour
{
    ...
    public bool isBomb;
    [SerializeField] bool requireDownwardPlayerMotion; //Requires the player to use the down attack to hurt
    [SerializeField] bool launchPlayerWhenKilled = true;
    ...
    public void GetHurt(int launchDirection, int hitPower)
    {
        ...
        {
            if (!requireDownwardPlayerMotion || (requireDownwardPlayerMotion && NewPlayer.Instance.velocity.y < -1))
            {
