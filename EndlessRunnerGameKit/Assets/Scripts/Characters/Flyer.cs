...
public class Flyer : MonoBehaviour
{
    ...
    [SerializeField] private Transform shootPosition; //Where does the bomb appear when instantiated?
    ...
    [SerializeField] private bool grounded; //If true, the enemy will be stable and not move
    ...
    void Start()
    {
        ...
        if (shootPosition == null) shootPosition = transform;
    }
    ...
    public void ShootBomb()
    {
        ...
        bombClone = Instantiate(bomb, new Vector3(shootPosition.transform.position.x, shootPosition.transform.position.y, shootPosition.transform.position.z), Quaternion.identity, null);
        Debug.Log(shootPosition.transform.parent.gameObject.name + " " + shootPosition.transform.parent.gameObject.transform.localEulerAngles);
        bombClone.transform.rotation = Quaternion.Euler(shootPosition.transform.parent.gameObject.transform.eulerAngles);
        Debug.Log(bombClone.gameObject.name + " " + bombClone.transform.localEulerAngles);
        bombClone.GetComponent<Rigidbody2D>().AddForce(bombClone.transform.up * 300);
